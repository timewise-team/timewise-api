...
func TestFunc32_UTCID01(t *testing.T) {
	...
	assert.Equal(t, "scheduleID is required", err.Error())
	mockDMS.AssertExpectations(t)
}
...
func TestFunc33_UTCID01(t *testing.T) {
	...
	assert.Equal(t, "Bad Request: Title is required", err.Error())
	mockDMS.AssertExpectations(t)
}
...
func TestFunc34_UTCID02(t *testing.T) {
	...
	err := service.DeleteSchedule("80", &workspaceUser)
...
func TestFunc35_UTCID01(t *testing.T) {
	...
	_, err := service.InviteToSchedule(&workspaceUser, invitedMember)
...
func TestFunc35_UTCID03(t *testing.T) {
	...
	scheduleParticipant, err := service.InviteToSchedule(&workspaceUser, invitedMember)
