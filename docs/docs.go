...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/account/user/emails/clear-rejected": {
            "get": {
                "security": [
                    {
                        "bearerToken": []
                ...
                "responses": {
                    "200": {
                        "description": "Clear status rejected email successfully",
                        "schema": {
                            "type": "string"
                        }
                    }
        ...
        "/api/v1/board_columns/workspace_id/{workspace_id}": {
            "get": {
                "security": [
                    {
                        "bearerToken": []
        ...
        "/api/v1/workspace_log/get-workspace-logs/workspace/{workspace_id}": {
            "get": {
                "security": [
                    {
                        "bearerToken": []
        ...
        "/api/v1/workspace_user/manage/wsp_user_list": {
            "get": {
                "produces": [
                    "application/json"
                ],
        ...
        "/api/v1/workspace_user/member/send-invitation": {
            "post": {
                "security": [
                    {
                        "bearerToken": []
